                          ...
                          <div className="flex flex-col gap-5 mt-2">
                            <div className="flex-1 flex flex-col">
                              ...
                              {availableModels.length > 0 ? (
                                <div className="w-full bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm px-5 focus-within:ring-4 ring-orange-400/30 transition-all h-[56px] flex items-center">
                                  <Select
                                    showSearch
                                    bordered={false}
                                    ...
                                    className="w-full text-base [&_.ant-select-selection-item]:!text-gray-900 dark:[&_.ant-select-selection-item]:!text-gray-100 [&_.ant-select-selection-placeholder]:!text-gray-400"
